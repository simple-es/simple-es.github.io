...
<p>Note: 2.x is the same exact protocol as 1.1. The version increment reflects a change in the internal error format
used by the module and used by the node API.</p>
...
<pre><code class="language-javascript">Hawk.sntp.start();</code></pre>
