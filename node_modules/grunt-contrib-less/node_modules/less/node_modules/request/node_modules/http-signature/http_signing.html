...
plain-string   = 1*( %x20-21 / %x23-5B / %x5D-7E )</code></pre>
...
<pre><code>Authorization: Signature keyId="rsa-key-1",algorithm="rsa-sha256",signature="Base64(RSA-SHA256(signing string))"</code></pre>
<p>The client would compose the signing string as:</p>
<pre><code>date: Tue, 07 Jun 2011 20:51:35 GMT</code></pre>
<h2>Header List</h2>
<p>The authorization header and signature would be generated as:</p>
<pre><code>Authorization: Signature keyId="rsa-key-1",algorithm="rsa-sha256",headers="request-line date content-type content-md5",signature="Base64(RSA-SHA256(signing string))"</code></pre>
<p>The client would compose the signing string as (<code>+ "\n"</code> inserted for
readability):</p>
<pre><code>POST /foo HTTP/1.1 + "\n"
date: Tue, 07 Jun 2011 20:51:35 GMT + "\n"
content-type: application/json + "\n"
content-md5: h0auK8hnYJKmHTLhKtMTkQ==</code></pre>
<h2>Algorithm</h2>
<p>The authorization header and signature would be generated as:</p>
<pre><code>Authorization: Signature keyId="hmac-key-1",algorithm="hmac-sha1",signature="Base64(HMAC-SHA1(signing string))"</code></pre>
<p>The client would compose the signing string as:</p>
<pre><code>date: Tue, 07 Jun 2011 20:51:35 GMT</code></pre>
...
URI: http://www.joyent.com</code></pre>
...
<pre><code>date: Thu, 05 Jan 2012 21:31:40 GMT</code></pre>
<p>The Authorization header would be:</p>
<pre><code>Authorization: Signature keyId="Test",algorithm="rsa-sha256",signature="ATp0r26dbMIxOopqw0OfABDT7CKMIoENumuruOtarj8n/97Q3htHFYpH8yOSQk3Z5zh8UxUym6FYTb5+A0Nz3NRsXJibnYi7brE/4tx5But9kkFGzG+xpUmimN4c3TMN7OFH//+r8hBf7BT9/GmHDUVZT2JzWGLZES2xDOUuMtA="</code></pre>
<h3>All Headers</h3>
